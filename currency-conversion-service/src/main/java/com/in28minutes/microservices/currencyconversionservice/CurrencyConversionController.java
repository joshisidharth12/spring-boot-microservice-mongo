...
public class CurrencyConversionController {
	...
	public CurrencyConversion calulatedCurrencyConversion(@PathVariable String from, @PathVariable String to,
	...
	public CurrencyConversion calulatedCurrencyConversionFeign(@PathVariable String from, @PathVariable String to,
			@PathVariable BigDecimal quantity) {
